...
from mcpower_gui.state import CITATION, SCENARIO_ORDER, _mcpower_version
...
class ResultPanel(QWidget):
    ...
    def _save_csv(self):
        ...
        try:
            ...
            fd, tmp_path = _tempfile.mkstemp(dir=dir_name, suffix=".csv.tmp")
            try:
                with _os.fdopen(fd, "w", encoding="utf-8-sig") as f:
                    f.write(content)
